...
public class AliYunSms {
	...
	static final String accessKeyId = "LTAILNpp9kNgCxMH";
	static final String accessKeySecret = "6DS58JNfPAqcBK7bOFI9Bp48lak7eh";
	...
	private static SendSmsResponse sendSms(String phone, String code) throws ClientException {
		...
		// 必填:短信签名-可在短信控制台中找到
		request.setSignName("智琢科技");
		// 必填:短信模板-可在短信控制台中找到
		request.setTemplateCode("SMS_133977809");
	...
	private static QuerySendDetailsResponse querySendDetails(String bizId, String phone) throws ClientException {
...
//			Utils.getLogger().error("服务器异常, 异常信息：" + e.getMessage(), e);
//		}
//		// 查明细
...
//				Utils.getLogger().error("服务器异常, 异常信息：" + e.getMessage(), e);
//			}
//			Utils.getLogger().info("Code=" + querySendDetailsResponse.getCode());
//			Utils.getLogger().info("Message=" + querySendDetailsResponse.getMessage());
//			return true;
//		}
//		return false;
		 return true;
	...
	//
	// // 发短信
	// SendSmsResponse response = sendSms("18715736535", "123456");
	...
	// querySendDetails(response.getBizId(), "18715736535");
